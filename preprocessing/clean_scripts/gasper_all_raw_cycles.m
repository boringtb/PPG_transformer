function target_features = gasper_all_raw_cycles(abp_section)
    ...
    if isempty(sbp_peaks) || isempty(dbp_valleys) || isempty(sbp_peaks(sbp_peaks > 60 & sbp_peaks < 220)) || isempty(dbp_valleys(dbp_valleys > 30 & dbp_valleys < 140))
    ...
    mean_sbp = mean(sbp_peaks((max_sbp - sbp_peaks) < 30 & sbp_peaks > 60 & sbp_peaks < 220));
    ...
    min_valley = min(dbp_valleys(dbp_valleys > 30 & dbp_valleys < 140));
    mean_dbp = mean(dbp_valleys( (dbp_valleys - min_valley) < 20 & dbp_valleys > 30 & dbp_valleys < 140));
